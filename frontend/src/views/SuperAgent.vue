...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'The AI Super Agent is the all-in-one assistant of the EK AI Intelligent Agent Platform. It can answer a wide range of professional questions, and provide accurate advice and tailored solutions.'
    },
    {
      name: 'keywords',
      content: 'AI Super Agent, Intelligent Assistant, Professional Q&A, AI Answers, Expert Advice, EK, AI Agent'
    }
  ]
})
